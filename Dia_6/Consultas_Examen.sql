...
select apellido1, apellido2, nombre, d.nombre
from profesor 
left join departamento d on p.id= d.id
order by apellido1, apellido2, nombre;

-- 4. Devuelve un listado con el nombre de las asignaturas, año de inicio y año de fin del curso escolar del alumno con nif 26902806M.
select nombre, anyo_inicio, anyo_fin
from asignatura 
join alumno_se_matricula_asignatura on id=m.id_asignatura
...
join imparticipaciones i on p.id= i.id_profesor;

-- 6. Devuelve un listado con todos los alumnos que se han matriculado en alguna asignatura durante el curso escolar 2018/2019.
select distinct nombre, apellido1, apellido2
from alumno
join alumno_se_matricula_asignatura on a.id=a_m_a.id_alumno
join asignatura on m.id_asignatura = id
